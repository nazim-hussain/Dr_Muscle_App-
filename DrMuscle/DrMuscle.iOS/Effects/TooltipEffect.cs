...
namespace DrMuscle.iOS.Effects
{
    public class iOSTooltipEffect : PlatformEffect
    {
        ...
        public void Show()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    tooltip.ArrowHeight = 15;
                    tooltip.ArrowWidth = 15;
        ...
        protected override void OnElementPropertyChanged(PropertyChangedEventArgs args)
        {
            ...
            else if (args.PropertyName == TooltipEffect.HasShowTooltipProperty.PropertyName)
            {
