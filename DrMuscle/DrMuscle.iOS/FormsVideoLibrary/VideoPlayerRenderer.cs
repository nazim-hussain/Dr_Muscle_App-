...
namespace FormsVideoLibrary.iOS
{
    public class VideoPlayerRenderer : ViewRenderer<VideoPlayer, UIView>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<VideoPlayer> args)
        {
            ...
            if (args.NewElement != null)
            {
                if (Control == null)
                {
                    ...
                    NSNotificationCenter.DefaultCenter.AddObserver(AVPlayerItem.DidPlayToEndTimeNotification, OnChange);
        ...
        void OnChange(NSNotification notification)
        {
            ...
            if (playerItem != null)
            {
                if ((ConvertTime(playerItem.CurrentTime) -  ConvertTime(playerItem.Duration)).TotalSeconds == 0)
                {
        ...
        void SetSource()
        {
            ...
            if (asset != null && Element.IsVisible)
            {
        ...
        void OnPlayRequested(object sender, EventArgs args)
        {
            player.Play();
            this.LayoutIfNeeded();
            _playerViewController.View.SetNeedsDisplay();
        }
