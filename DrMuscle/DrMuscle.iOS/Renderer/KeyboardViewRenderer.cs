        ...
        void OnKeyboardShow(object sender, UIKeyboardEventArgs args)
        {
            ...
            if (Element != null)
            {
                ...
                if (UIDevice.CurrentDevice.CheckSystemVersion(11, 0))
                    keyboardHeight = keyboardSize.Height - 54;
                Element.Margin = new Thickness(0, 0, 0, keyboardHeight); //push the entry up to keyboard height when keyboard is activated
