...
[assembly: ExportRenderer(typeof(ExtendedLightBlueLabel), typeof(ExtendedLightBlueLabelRender))]
namespace DrMuscle.iOS.Renderer
{
    public class ExtendedLightBlueLabelRender : LabelRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Label> e)
        {
            ...
            var view = (ExtendedLightBlueLabel)Element;
            if (view == null) return;
            ...
            var dictionary = new NSDictionary(
                UIStringAttributeKey.ForegroundColor, Color.FromHex("#97D2F3").ToUIColor(),
                UIStringAttributeKey.UnderlineColor, Color.FromHex("#97D2F3").ToUIColor()
            );
