...
namespace DrMuscle.Effects
{
    ...
    public static class TooltipEffect
    {
        ...
        public static readonly BindableProperty HasShowTooltipProperty =
          BindableProperty.CreateAttached("HasShowTooltip", typeof(bool), typeof(TooltipEffect), false);
        ...
        public static bool GetHasShowTooltip(BindableObject view)
        {
            return (bool)view.GetValue(HasShowTooltipProperty);
        }

        public static void SetHasShowTooltip(BindableObject view, bool value)
        {
            view.SetValue(HasShowTooltipProperty, value);
        }
    ...
    {
        public ControlTooltipEffect() : base("CubiSoft.TooltipEffect")
        {
